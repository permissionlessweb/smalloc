...
//
// The current settings of simpalloc (v4.0.0) require 59,785,944,760,326 bytes of virtual address space.
//
// Now working on simpalloc v5.0.0 which requires only 29,824,252,903,423 bytes of virtual address space.
//
// 2025-11-29: The current simpalloc (v6.0.4) requires 17,313,013,178,111 bytes.
//
// 2025-11-29: The current simpalloc (v6.0.5) requires 35,175,782,162,431 bytes.
//
// 2025-11-30: The current simpalloc (v6.1.0) requires 70,360,154,259,455 bytes.
//
// 2025-12-11: The current simpalloc (v7.1.0) requires 70,360,449,210,367 bytes.
// 
// 2025-12-16: The current simpalloc (v7.2.0) requires 70,366,596,694,014 bytes.
//
// 2026-01-04: The current simpalloc (v7.4.9) requires 35,182,224,605,182 bytes.
